...
from 
	sys.master_files mf
	join 
	sys.dm_io_virtual_file_stats(NULL, NULL) vfs on mf.database_id=vfs.database_id and mf.file_id=vfs.file_id
order by 
...
select 
	left(mf.physical_name, 1) as drive_letter, sample_ms
